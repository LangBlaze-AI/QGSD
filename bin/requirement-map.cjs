...
const CHECK_ID_TO_REQUIREMENTS = {
  ...
  // Alloy models generated by solve-remediate (iteration 1)
  'alloy:statusline-context-tiers':     ['DIAG-10'],
  'alloy:formalism-selection':          [],
  'alloy:model-registry-parity':        [],
};
