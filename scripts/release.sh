...
echo "@next to match @latest (OIDC may not authorize dist-tag — if it warns, run"
echo "'npm dist-tag add @nforma.ai/nforma@<version> next'). A prerelease publishes @next only."
echo ""
