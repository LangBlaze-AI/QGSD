...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("bug_TTrace_1782723641.json", _TETrace)
...
expression == 
    [
        ...
        \* ,_crashedUnchanged |-> crashed = crashed'
        
        \* Format the `crashed` variable as Json value.
        \* ,_crashedJson |->
        \*     LET J == INSTANCE Json
        \*     IN J!ToJson(crashed)
        ...
        \*         IF s = 1 THEN 0
        \*         ELSE IF _TETrace[s].crashed # _TETrace[s-1].crashed
...
\*
\*trace == IODeserialize("bug_TTrace_1782723641.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    <<
    ([entry |-> "null",crashed |-> FALSE]),
    ([entry |-> "null",crashed |-> TRUE])
    >>
----
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Jun 29 10:00:41 WEST 2026