...
VARIABLES
    ...
    minLiveVoters,  \* default: 2  annotation: (no annotation)
...
TypeOK ==
    ...
    /\ minLiveVoters \in Nat  \* FIXME: tighten bound if needed
...
\* COLLECTING_VOTES -[VOTES_COLLECTED / unanimityAndFloorMet]-> DECIDED
CollectingVotesVotesCollectedToDECIDED(c) ==
    /\ state = "COLLECTING_VOTES"
    /\ c = polledCount /\ c >= minLiveVoters
    /\ state' = "DECIDED"
...
\* DELIBERATING -[VOTES_COLLECTED / unanimityAndFloorMet]-> DECIDED
...
\* DELIBERATING -[VOTES_COLLECTED / floorMet]-> DECIDED
DeliberatingVotesCollectedToDECIDEDFloormet ==
    /\ state = "DELIBERATING"
